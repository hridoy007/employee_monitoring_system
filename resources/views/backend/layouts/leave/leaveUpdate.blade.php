...
{{--                    <a class="btn btn-danger" href="{{route('leave.edit',$data->id)}}">Edit</a>--}}
                    ...
                    <form class="form-horizontal" method="post" action="{{route('leave.update',$leave->id)}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="cols-sm-10">
                                <div class="input-group">
                                    ...
                                    <input value="{{$leave->total_leave}}" type="text" class="form-control" name="totalLeave" id="Text" placeholder="" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="cols-sm-10">
                                <div class="input-group">
                                    <span class="input-group-addon"></span>
                                    <input value="{{$leave->leave_taken}}" type="text" class="form-control" name="leaveTaken" id="Text" placeholder="" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="cols-sm-10">
                                <div class="input-group">
                                    <span class="input-group-addon"></span>
                                    <input value="{{$leave->leave_available}}" type="text" class="form-control" name="leaveAvailable" id="Text" placeholder="" />
                                </div>
                            </div>
                        </div>
