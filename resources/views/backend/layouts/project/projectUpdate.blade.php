                    ...
                    <form class="form-horizontal" method="post" action="{{route('project.update',$project->id)}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="cols-sm-10">
                                <div class="input-group">
                                    ...
                                    <input value="{{$project->project_name}}" type="text" class="form-control" name="projectName" id="name" placeholder="Name" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="cols-sm-10">
                                <div class="input-group">
                                    <span class="input-group-addon"></span>
                                    <input value="{{$project->dept_name}}" type="text" class="form-control" name="deptName" id="Name" placeholder="Name" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="cols-sm-10">
                                <div class="input-group">
                                    <span class="input-group-addon"></span>
                                    <input value="{{$project->deadline}}" type="date" class="number" name="date" id="Date" placeholder="Last Date of submission" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon"></span>
                            <input value="{{$project->project_code}}" type="text" class="form-control" name="projectCode" id="projectCode" placeholder="Code" />
                        </div>
